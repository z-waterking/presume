...
最近一年，我将重心转向了 **Generative AI**。我负责了内部 Agent 平台 **BingViz** 的核心研发，构建了基于 **LLM + MCP** 的深度分析引擎，成功实现了自动化的业务归因。此外，我在 Global Hackathon 中发起的 **SkillLoop** 项目，探索了 "Document-Driven Development" 的新范式，获得了全球季军，并向 AI CEO 做了汇报。
