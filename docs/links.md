...
> 本节只放新增材料，避免和上文重复。详细阅读顺序见 `学习材料/` 下三份主题文件。
...
- [ ] [MIND](https://arxiv.org/abs/1904.08030) — 阿里 CIKM 2019，多兴趣召回。
- [ ] [ComiRec](https://arxiv.org/abs/2005.09347) — KDD 2020，可控多兴趣召回。
- [ ] [TDM](https://arxiv.org/abs/1801.02294) — 阿里，树检索召回。
- [ ] [PinSage](https://arxiv.org/abs/1806.01973) — Pinterest KDD 2018，图卷积大规模推荐。
- [ ] [Pixie](https://dl.acm.org/doi/10.1145/3219819.3219846) — Pinterest KDD 2018，图随机游走推荐。
- [ ] [Reciprocal Rank Fusion](https://plg.uwaterloo.ca/~gvcormac/cormacksigir09-rrf.pdf) — 排名融合，可与 Borda Count 对比。
- [ ] [Microsoft Recommenders](https://github.com/recommenders-team/recommenders) — 推荐系统工业样例库。
- [ ] [RecBole](https://github.com/RUCAIBox/RecBole) — 推荐系统统一实验框架。
- [ ] [Feast Feature Store](https://docs.feast.dev/) — 训练/服务特征一致性参考。

### 5.2 搜索广告 / 计算广告新增材料

- [ ] [CDSSM](https://www.microsoft.com/en-us/research/publication/a-latent-semantic-model-with-convolutional-pooling-structure-for-information-retrieval/) — MSR，DSSM 的卷积版本。
- [ ] [Duet](https://www.microsoft.com/en-us/research/publication/learning-to-match-using-local-and-distributed-representations-of-text-for-web-search/) — MSR，精确匹配 + 语义匹配双通道。
- [ ] [DRMM](https://arxiv.org/abs/1711.08611) — 文本相关性匹配模型。
- [ ] [ANCE](https://arxiv.org/abs/2007.00808) — 稠密检索训练与 hard negative。
- [ ] [ColBERTv2](https://arxiv.org/abs/2112.01488) — Late interaction 检索模型。
- [ ] [Optimal Real-Time Bidding for Display Advertising](https://arxiv.org/abs/1407.7073) — 预算约束竞价优化。
- [ ] [Pacing Equilibria in First Price Auction Markets](https://arxiv.org/abs/1706.07151) — 预算节奏控制理论。
- [ ] [Trustworthy Online Controlled Experiments](https://experimentguide.com/) — A/B 实验系统材料。
- [ ] [CUPED](https://exp-platform.com/Documents/2013-02-CUPED-ImprovingSensitivityOfControlledExperiments.pdf) — 提升实验灵敏度，适合解释成熟广告系统小收益显著性。

### 5.3 AI Agent 新增材料

- [ ] [Plan-and-Solve Prompting](https://arxiv.org/abs/2305.04091) — 规划式 Agent 推理。
- [ ] [Tree of Thoughts](https://arxiv.org/abs/2305.10601) — 树搜索推理，可对比你的树形归因。
- [ ] [Reflexion](https://arxiv.org/abs/2303.11366) — 反思式 Agent。
- [ ] [Voyager](https://arxiv.org/abs/2305.16291) — 长期技能库与自我改进。
...
- [ ] [Semantic Kernel](https://learn.microsoft.com/en-us/semantic-kernel/overview/) — 微软插件/Agent 编排框架。
- [ ] [Gorilla](https://arxiv.org/abs/2305.15334) — LLM 调用大量 API。
- [ ] [ToolLLM](https://arxiv.org/abs/2307.16789) — Tool-use 数据与评估。
- [ ] [Ragas](https://docs.ragas.io/) — RAG/Agent 评估。
- [ ] [DeepEval](https://docs.confident-ai.com/) — LLM 单元测试。
- [ ] [OpenTelemetry GenAI Semantic Conventions](https://opentelemetry.io/docs/specs/semconv/gen-ai/) — 生产 tracing 标准化。
- [ ] [OWASP Top 10 for LLM Applications](https://owasp.org/www-project-top-10-for-large-language-model-applications/) — LLM 安全与 prompt injection。
- [ ] [SWE-bench](https://www.swebench.com/) — 代码 Agent 评测基准。
